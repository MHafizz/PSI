...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2023 at 02:09 AM
...
(1, 'Obat A', 10000, 50, 'KDP001', '2023-07-11', 'Supplier A', 'A'),
...
(10, 'Obat J', 28000, 55, 'KDP010', '2023-07-31', 'Supplier A', 'A'),
(11, 'Obat K', 18000, 85, 'KDP011', '2023-08-15', 'Supplier A', 'B');
...
--
ALTER TABLE `barangmasuk`
  ADD CONSTRAINT `barangmasuk_ibfk_1` FOREIGN KEY (`ID_Obat`) REFERENCES `obat` (`ID_Obat`);
