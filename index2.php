                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold" style="color: #617A55;"><?php echo number_format($rowharian[0], 0, ',', '.');  ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <a href ="tables.php">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="font-size: 20px; color: #B3C99C;">
                                                Cabang Apotek</div>
                                            <div class="h5 mb-0 font-weight-bold" style="color: #617A55;"><?php echo number_format($rowbulan[0], 0, ',', '.'); ?></div>
                                        </div>
                                        <div class="col-auto">
                                        <a href ="store.php">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="font-size: 20px; color: #B3C99C;">
                                                Obat Terjual</div>
                                            <div class="h5 mb-0 font-weight-bold" style="color: #617A55;"><?php echo number_format($rowttahun[0], 0, ',', '.'); ?></div>
                                        </div>
                                        <div class="col-auto">
                                        <a href ="#">
